...
created: 2026-08-01
updated: 2026-08-01T19:48:19+08:00
revision: 2026-08-01
sources:
  - path: 2026-08-01_1939__manual__theme_update/reference.md
    agent: theme_update
    summarized: false
---
...
1. [欧盟 FSR 指控 Temu 阻挠调查（2026-08-01）](reports/event-1.md) — ：这是 FSR（外国补贴条例）框架下的严重升级。如果最终认定 Temu 违规，可能面临结构性运营限制（如被禁止参与欧盟公共采购），这比罚款的影响深远得多。
2. [Temu 物流模式转型：关国内仓、建欧洲仓（2026-07-31）](reports/event-2.md) — ：转型方向正确，但时机不佳。在美国取消小包免税政策、欧盟加强监管的背景下，本地化仓储是长期生存的必要条件，但短期内资本支出和运营成本将大幅上升。
3. [PDD 雄安公司扩招（2026-07-31）](reports/event-3.md) — 雄安公司员工已超 3,000 人，计划未来一年再招 5,000 人。这可能与 AI 和技术基础设施建设有关，但也意味着人力成本的上升趋势。
4. [国美零售债务重组涉及 PDD（2026-07-30）](reports/event-4.md) — 国美零售推进整体离岸债务重组，与拼多多的谈判尚未解决。此项涉及金额有限，对 PDD 影响较小。
...
| 悲观情景 | 净利润 $13B（-5% YoY），利润率持续恶化 | 10x PE → $88 | — | — |
| 基准情景 | 净利润 $15B（+10% YoY），Temu 转型初见成效 | 11x PE → $112 | — | — |
| 乐观情景 | 净利润 $17B（+24% YoY），利润率显著回升 | 13x PE → $150 | — | — |
