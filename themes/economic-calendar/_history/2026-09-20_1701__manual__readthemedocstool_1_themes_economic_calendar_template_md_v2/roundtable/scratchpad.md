...
【目标周 · 代码锁定 禁止自行推断或修改】本周 = 2026-09-21（周一）至 2026-09-27（周日）。报告标题与所有日期表述必须以此为准；周历表头第二行必须逐字复制：| 周一 09-21 | | 周二 09-22 | | 周三 09-23 | | 周四 09-24 | | 周五 09-25 | | 周六 09-26 | | 周日 09-27 |。
【承接 · 硬性要求】用 ReadThemeDocsTool 读取上周 recap.md（路径 themes/2026-09-14__2026-09-20/recap.md）： ① 观察清单逐条承接进「日历外的已知未知」； ② 成绩单用于校准置信度。
...

{
  "action": "finalize",
  "questions": [],
  "confirmed_missing_indicators": ["10Y_ust_yield", "2Y_ust_yield", "dxy_index", "brent_crude_price", "gold_price", "usdcnh_rate"],
  "confirmed_event_mappings": [
    {
      "event": "9月五年期贷款市场报价利率(LPR)",
      "country": "CN",
      "indicator_key": "lpr_5y_cn"
    },
    {
      "event": "9月一年期贷款市场报价利率(LPR)",
      "country": "CN",
      "indicator_key": "lpr_1y_cn"
    },
    {
      "event": "9月制造业PMI初值",
      "country": "EU",
      "indicator_key": "manufacturing_pmi_eu_prelim"
    }
  ],
  "actions": []
}
