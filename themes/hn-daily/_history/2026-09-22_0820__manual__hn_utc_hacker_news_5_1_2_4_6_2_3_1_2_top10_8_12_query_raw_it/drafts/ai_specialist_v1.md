...
> 今日三句话：① Grok 4.7 发布，CursorBench 46.3% 与 Fable 5.1 打平但价格仅为 1/5；② ZuckOff 应用监听蓝牙识别 Meta 智能眼镜，隐私对抗进入"被动监听"时代；③ Bryan Cantrill 揭 Sun 衰落根因：战略正确但厌倦运营执行。
...
| --- | --- |
| 热度 | ▲ 471 · 💬 387 · 作者 meetpateltech · 2026-09-21 |
...
| 评论摘录 | [HN 评论页](https://news.ycombinator.com/item?id=49788838) — 未能抓取评论 |

### 2. ZuckOff：蓝牙被动监听识别 Meta 智能眼镜

| 原文 | [ZuckOff](https://zuckoff.app/) |
| --- | --- |
| 热度 | ▲ 586 · 💬 5 · 作者 Bluestein · 2026-09-21 |
...
| 评论摘录 | [HN 评论页](https://news.ycombinator.com/item?id=49785429) — 未能抓取评论 |
...
| --- | --- |
| 热度 | ▲ 522 · 💬 0 · 作者 zer0tonin · 2026-09-21 |
...
| --- | --- |
| 热度 | ▲ 461 · 💬 317 · 作者 DeepLogin · 2026-09-21 |
...
| --- | --- |
| 热度 | ▲ 445 · 💬 245 · 作者 chmaynard · 2026-09-21 |
...
| --- | --- |
| 热度 | ▲ 145 · 💬 84 · 作者 1vuio0pswjnm7 · 2026-09-21 |
| 摘要 | 金融时报报道，AI 聊天机器人在回答金融查询时"多数时候给出错误答案"。文章未提供具体错误率数字，但标题直接点明可靠性问题。此报道与 HN 社区对 AI 金融应用的持续质疑形成呼应。 |
...
| 摘要 | Cloudflare 宣布 Python Workers 正式进入 GA（通用可用）阶段，开发者现可在边缘计算环境中运行 Python 代码。这标志着 Serverless Python 生态从 Node.js/Go 主导向多语言扩展的重要节点。 |
...
| 摘要 | Raspberry Pi 基金会通过技术手段阻止用户更换 RAM 芯片，论坛帖子引发社区争议。此举被解读为对硬件可修复性和用户自主权的限制，与开源硬件精神形成张力。 |
...
| --- | --- |
| 热度 | ▲ 205 · 💬 92 · 作者 ano-ther · 2026-09-21 |
...
| # | 原文标题 | 中文标题 | 分数 | 评论 |
| --- | --- | --- | --- | --- |
| 1 | [ZuckOff](https://zuckoff.app/) | ZuckOff 摄像头眼镜检测器 | 586 | 5 |
| 2 | [Attention is all you have](https://alicegg.tech/2026/09/21/attention) | 注意力就是你拥有的一切 | 522 | 0 |
| 3 | [Grok 4.7](https://x.ai/news/grok-4-7) | Grok 4.7 发布 | 471 | 387 |
| 4 | [Disney+ ad policy change](https://consumerrights.wiki/w/Disney%2B_ad_policy_change) | Disney+ 广告政策变更 | 461 | 317 |
| 5 | [What Sun Got Wrong](https://bcantrill.dtrace.org/2026/09/20/what-sun-got-wrong/) | Sun 做错了什么 | 445 | 245 |
| 6 | [Kev](https://github.com/jaredpalmer/kev/tree/main) | Kev：轻量决策模型家族 | 376 | 168 |
...
| 9 | [ZuckOff (Wired)](https://www.wired.me/story/meta-smart-glasses-detector-app-zuckoff) | ZuckOff：在 Meta 眼镜看到你之前发现它们 | 309 | 303 |
| 10 | [Mini-AGI](https://github.com/volotat/mini-AGI/) | Mini-AGI：8GB 显存从零训练的持续学习模型 | 246 | 51 |