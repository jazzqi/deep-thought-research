...
- `transcript_01.md`（第 1/2 段）
- `transcript_02.md`（第 2/2 段）
> ⚠️ 用 ReadThemeDocsTool 依次读取全部段文件后再动笔，禁止只读第一段就写作；段文件路径前缀：`themes/podcast-digest/_episode/the-daily/transcript_XX.md`。